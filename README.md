...
# 状态
 ...
 - 方法 2 无需使用Modified AppleALC 或者 FakePCIID 可尝试 注入device-id D07A0000 `(需要原版AppleALC Release 1.6.7或更高版本)` 同时IceLake-LP 或者 Z490 H470 W480 Q470 等平台如果出现核显的核显数字音频(DP HDMI)无法使用也可尝试此方法
